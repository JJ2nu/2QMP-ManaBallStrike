...
{
    class BossBullet : public Engine::Object::Base, public Engine::Collisionable
    {
    public:
        BossBullet(const Engine::Math::Vector2& location, const Engine::Math::Vector2& direction);
